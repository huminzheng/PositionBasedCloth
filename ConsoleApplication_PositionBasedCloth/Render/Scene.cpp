...
const 
{
	...
	glUniform3f(glGetUniformLocation(clothPieceShader->Program, "material.ambient"), 0.6f, 0.6f, 0.6f);
	glUniform3f(glGetUniformLocation(clothPieceShader->Program, "material.diffuse"), 0.6f, 0.6f, 0.6f);
	glUniform3f(glGetUniformLocation(clothPieceShader->Program, "material.specular"), 0.1f, 0.1f, 0.1f);
	glUniform1f(glGetUniformLocation(clothPieceShader->Program, "material.shininess"), 0.03f);
