...
/* WARNING: cannot draw polygon (edges=n!=3) mesh properly,
	due to the mesh.indices arranged with n (which is right), 
	rather than 3 (needed by OpenGL),
	but the data is right and work properly
	*/
